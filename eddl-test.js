...
},{"./common-event-listener":4}],2:[function(require,module,exports){
"use strict";
...
},{"./adobe-main":2,"./google-main":6}],4:[function(require,module,exports){
"use strict";
...
var _commonFunctions = _interopRequireDefault(require("./common-functions"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /* global scAnalyticsDataArray, digitalData, Utils */ /*
...
var CommonEventListener = /*#__PURE__*/function () {
  ...
  _createClass(CommonEventListener, [{
    ...
    value: function init() {
      var that = this;
      var linkName = '';
      var pageSlug = document.querySelector('meta[name="sc:page-slug"]') ? document.querySelector('meta[name="sc:page-slug"]').getAttribute('content') : null;
      ...
      if (window.digitalData.page.pageInfo && window.digitalData.page.pageInfo.pageName) {
        ...
        if (_pageName.length <= 8) {
          ...
          if (mktCountryCode == 'hk') {
            ...
            pageNameList.push(_pageName[_pageName.length - 1] ? _pageName[_pageName.length - 1] : 'na');
          } else {
      ...
      if (mktCountryCode == 'hk') {
        ...
        window.digitalData.page.pageInfo.pageName = _pageName2.join(':');
        //Add user info
      ...
      if (metaTitle && (metaTitle.getAttribute('content') == '404-error-page' || metaTitle.getAttribute('content') == '404 Error Page')) {
        ...
        if (mktCountryCode !== 'hk') {
          var _pageName3 = window.digitalData.page.pageInfo.pageName.split(':');
          if (_pageName3[4] != 'na' || _pageName3[5] != 'na' || _pageName3[6] != 'na') {
        ...
        //Capture campaign
        var allowableQueryString = Utils.constants.ALLOWABLE_QUERYSTRING.scb;
        var _pageName4 = window.digitalData.page.pageInfo.pageName.split(':');
        if (_pageName4[0] == 'pk' && _pageName4[3] == 'udp-form' || _pageName4[0] == 'in' || _pageName4[0] == 'hk') {
          var campaignData = Utils.getIntExtCampaignInfo(_pageName4[0]);
          ...
          var _campaignData = that.getCampaignInfo(allowableQueryString);
        ...
        var eventName = mktCountryCode == 'hk' ? 'page-view' : 'pageView';
        ...
        if (mktCountryCode !== 'hk') {
          if (window.digitalData.page.pageInfo) {
            var _pageName5 = window.digitalData.page.pageInfo.pageName.split(':');
            if (_pageName5[4] != 'na' || _pageName5[5] != 'na' || _pageName5[6] != 'na') {
      ...
      document.body.addEventListener('click', function (event) {
        ...
        var isCloseModalButton = event.target['dataset'].send === 'close-modal' ? true : false;
        ...
        if (typeof event.target.className === 'string' && typeof event.target.className.includes !== 'undefined' && event.target.className.indexOf('c2c_text_content') !== -1 && !document.getElementsByClassName('sc-offers').length) {
          ...
          var ctaType = closestAnchor ? that.getCtaType(closestAnchor.className, event.target) : 'link';
          ...
          var _dataObject2 = _objectSpread(_objectSpread({}, digitalData), {}, {
            customLinkClick: {
              ...
              customLinkRegion: _commonFunctions.default.getHorizontalPosition(event.clientX) + ' ' + Utils.calcElementLocation(event.target),
          ...
          _dataObject2.ctaPosition = Utils.calcElementLocation(event.target);
          ...
          var _ctaType = that.getCtaType(closestAnchor.className, event.target);
          ...
          if (event.target.closest('.m-search-result ul.list') && pageSlug == 'search' && !document.getElementsByClassName('sc-offers').length) {
          ...
          } else if ((event.isTrusted || mktCountryCode == 'hk' && !fileDownloadNewTab) && (!event.target.closest('.is-external-link-button') && closeModal != 'close-modal' && !event.target.closest('.modal-content') || event.target.closest('.sc-external-link-button') || event.target.closest('.is-external-link-button') || modalContent) && !document.getElementsByClassName('sc-offers').length) {
            ...
            var _eventName = _commonFunctions.default.urlBreakdown(url).extension == 'pdf' ? 'fileDownload' : 'ctaClick';
            if (mktCountryCode == 'hk') {
              _eventName = 'ctaClick'; //Track file download link clicks as CTA clicks, in HK
            }

            var _dataObject3 = _objectSpread(_objectSpread({}, digitalData), {}, {
              customLinkClick: {
            ...
            _dataObject3.ctaPosition = Utils.calcElementLocation(event.target);
          ...
          if (!url) {
            ...
            return;
          } else if (!that.isInternalDomain(urlBreak.domain) && urlBreak.domain !== '' && urlBreak.domain !== document.location.hostname && closeModal != 'close-modal' && url.charAt(0) !== '/') {
            /**
            ...
            if (!that.isInternalDomain(urlBreak.domain) && modalTarget && modalTarget.getAttribute('data-modal-id') !== undefined && modalTarget.getAttribute('data-modal-id') != 'external-links-disclaimer') {
              return;
            }
        ...
        } else if (isCloseModalButton && event.isTrusted && !document.getElementsByClassName('sc-offers').length && mktCountryCode !== 'hk') {
          var _ctaType2 = closestAnchor ? that.getCtaType(closestAnchor.className, event.target) : 'link';
          var _dataObject4 = _objectSpread(_objectSpread({}, digitalData), {}, {
            user: {
              userInfo: {
                userStatus: 'guest',
                userType: 'NTB'
            ...
            customLinkClick: {
              ...
              customLinkRegion: _commonFunctions.default.getHorizontalPosition(event.clientX) + ' ' + _commonFunctions.default.calcElementLocation(event.target),
          ...
          _dataObject4.ctaPosition = _commonFunctions.default.calcElementLocation(event.target);
      ...
      if (search) {
        ...
        search.addEventListener('keyup', that.delayFiveSeconds(function () {
          if (searchEvent) {
            ...
            var numOfResults = parseInt(document.querySelector('li:first-child span.counter').innerText);
            var _dataObject5 = _objectSpread(_objectSpread({}, digitalData), {}, {
              event: 'siteSearch',
              title: document.title,
              href: window.location.href,
              context: keyword
      ...
      //privileges module
      var labels = document.querySelectorAll('.sc-privileges__step-item');
      if (labels.length) {
    ...
    value: function privilegesModuleTracking(event) {
      var ctaName = event.target.getAttribute('title');
      var ctaType = 'link';
      var linkName = document.querySelector('title') && document.querySelector('title').innerText ? document.querySelector('title').innerText.toLowerCase() : 'na';
      var closest = e.target.closest('.sc-privileges__content-wrapper');
      var customLinkText = closest.innerText ? closest.innerText.trim().toLowerCase() : closest.textContent.trim().toLowerCase();
      var dataObject = _objectSpread(_objectSpread({}, digitalData), {}, {
        customLinkClick: {
          customLinkText: customLinkText,
          customLinkRegion: _commonFunctions.default.getHorizontalPosition(event.clientX) + ' ' + Utils.calcElementLocation(closest),
          customLinkType: ctaType,
          customLinkName: linkName
        },
        event: 'ctaClick',
    ...
    value: function getCtaType(className, target) {
      if (target && target.closest('.sc-nav')) {
        return 'nav-link';
      } else if (className == '' || typeof className !== 'string' || typeof className.includes === 'undefined') {
        return 'link';
      } else if (className.indexOf('sc-btn-tile') !== -1) {
        return 'tile';
      } else if (className.indexOf('sc-btn') !== -1 || className.indexOf('c-button') !== -1) {
        return 'button';
      } else if (className.indexOf('sc-bnr__link') !== -1 || className.indexOf('slide-anchor-bg') !== -1) {
        return 'banner';
    ...
    value: function getCampaignInfo(allowableQueryString) {
      ...
      for (var i = 0; i < total; i++) {
        var cookieValue = _commonFunctions.default.getCookie(allowableQueryString[i]);
        var localStorageValue = Utils.getLocalStorageWithExpiry(allowableQueryString[i]);
...
},{"./analytics-event-handler":3,"./common-functions":5}],5:[function(require,module,exports){
"use strict";
...
var CommonFunctions = /*#__PURE__*/function () {
  ...
  _createClass(CommonFunctions, [{
    ...
    value: function calcElementLocation(target) {
      ...
      if (target.closest('.m-persistent-bar') || target.closest('.sc-persistent-bar') || target.closest('.m-persistent-bootom-bar')) {
      ...
      var scrollDepth = parseInt(this.getPosition(target)) * 100 / maxHeight;
    ...
    value: function urlBreakdown(currentURL) {
      ...
      if (parts.length <= 4 && CommonFunctions.constants.LANGUAGES.indexOf(pageURL.slug) !== -1) {
    ...
    value: function getPageContext() {
      ...
      return that.extend(that.urlBreakdown(window.location.href), pageContext);
    }
  }, {
    key: "extend",
    ...
    value: function getCountryNameFromURL() {
      ...
      var removeHTTP = url.replace('http://', '').replace('https://', '');
      var splitURL = removeHTTP.split('/');
      var currentEnvironment = that.getCurrentEnvironment();
      return CommonFunctions.constants.DEVELOPMENT === currentEnvironment || CommonFunctions.constants.STAGING === currentEnvironment ? splitURL[2] : splitURL[1];
    }
  }, {
    key: "getCurrentEnvironment",
    value: function getCurrentEnvironment() {
      var that = this;
      var urlObj = ['cmsdev', 'preview', 'standardchartered', 'sc', 'com', 'av', 'assets', 'global', 'development', 'staging', 'digital', 'https', 'cmsstage', 'cms', 'dev', 'zoo'];
      ...
      if (domain.indexOf(urlObj[3] + '.' + urlObj[4]) !== -1) {
        ...
        if (that.getPageUrl().pathname.match('^/staging')) {
          return CommonFunctions.constants.STAGING;
        } else if (that.getPageUrl().pathname.match('^/development')) {
          return CommonFunctions.constants.DEVELOPMENT;
        } else {
          return CommonFunctions.constants.PREVIEW;
        }
    ...
    value: function previewLog(log) {
      var that = this;
      if (that.getCurrentEnvironment() === CommonFunctions.constants.PREVIEW || that.getCurrentEnvironment() === CommonFunctions.constants.DEVELOPMENT) {
...
_defineProperty(CommonFunctions, "constants", {
  ...
  LANGUAGES: ['en', 'zh'],
  ALLOWABLE_QUERYSTRING: ['subChanCode', 'camp_id', 'pid', 'promoCode', 'promo', 'referId', 'instance', 'state', 'utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'GiPrm', 'productName', 'truspleBuyerId']
});
